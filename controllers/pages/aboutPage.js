...
function aboutPage(req, res, next) {
  ...
  <html lang="en">
    <head>
      ...
      <link rel="icon" type="image/x-icon" href="http://localhost:8001/favicon.ico"/>
      ...
      <meta property="og:url" content="http://localhost:8001/pages/about">
      ...
      <meta property="og:image" content="http://localhost:8001/images/minili-illustration.svg">
      
      <!-- Twitter -->
      <meta property="twitter:card" content="summary_large_image">
      <meta property="twitter:url" content="http://localhost:8001/pages/about">
      ...
      <meta property="twitter:image" content="http://localhost:8001/images/minili-illustration.svg">
  
      <link rel="preconnect" href="https://fonts.googleapis.com">
      <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
      <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,700;1,400&display=swap" rel="stylesheet"> 
      <link rel="stylesheet" href="http://localhost:8001/styles/index.css"/>
